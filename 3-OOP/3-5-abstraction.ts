{
  ...
  // interface => 나는 이런 행동을 하고있어 라고 명시해두는 계약서 같은 아이
  interface CoffeeMaker {
    makeCoffee(shots: number): CoffeeCup;
  }
  // 🌼 커피메이커라고 하는 인터페이스는 메이크 커피라는 함수가 있어 샷은 넘버를 받고 커피컵을 리턴 받을수있어! U know I'm saying?
  ...
  //2.interface를 통해서도 가능하다.
  // const maker2: CoffeeMaker = CoffeeMachine.makeMachine(32);
  // 커피머신은 커피메이커의 인터페이스를 구현하지만 커피메이커 안에는 makeCoffee함수만 존재한다.
  // 때에 따라서 내가 얼마만큼의 행동을 약속할건지 허용할건지 보장할건지 결정 할 수 있다.
  // maker2.fillCoffeeBeans(37); => 사용 할 수 없음!
  // maker2.makeCoffee(2);
}
